/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brighter imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brighter.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_BrighterPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_BrighterPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brighter";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_EYE_INERTIA", (float)1500.000000);
            OverrideParam("BLOOM_GAMMA", (float)3.000000);
            OverrideParam("BLOOM_GAMMA_OUT", (float)2.200000);
            OverrideParam("BLOOM_MIX", (float)0.300000);
            OverrideParam("BLOOM_OVER_WHITE", (float)0.500000);
            OverrideParam("BLOOM_POWER", (float)2.000001);
            ...
            OverrideParam("PIXELGRID_H_DEDOT", (float)0.700000);
            ...
            OverrideParam("PIXELGRID_Y_MASK_OFFSET_DEHIVE", (float)0.700000);
