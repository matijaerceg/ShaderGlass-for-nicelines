/*
ShaderGlass preset bezel/koko-aio / Monitor-Ambilight-immersive imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Ambilight-immersive.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorAmbilightImmersivePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorAmbilightImmersivePresetDef() : PresetDef{}
	{
		Name = "Monitor-Ambilight-immersive";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("AMBI_FALLOFF", (float)0.350000);
            OverrideParam("AMBI_GAMMA", (float)1.300000);
            OverrideParam("AMBI_INT_OFFSET", (float)-0.300000);
            OverrideParam("AMBI_OVER_BEZEL", (float)2.049999);
            OverrideParam("AMBI_OVER_BEZEL_SIZE", (float)0.223000);
            OverrideParam("AMBI_POWER", (float)1.000000);
            OverrideParam("AMBI_STEPS", (float)5.000000);
            OverrideParam("AMBI_STRETCH", (float)0.800000);
            OverrideParam("BEZEL_B", (float)-0.005000);
            OverrideParam("BEZEL_CON", (float)1.000000);
            OverrideParam("BEZEL_CORNER_DARK", (float)0.500000);
            OverrideParam("BEZEL_DIFFUSION_STR", (float)0.600000);
            OverrideParam("BEZEL_FRAME_ZOOM", (float)0.179000);
            OverrideParam("BEZEL_G", (float)0.010000);
            OverrideParam("BEZEL_LIGHT_NO_FADEOUT", (float)1.000000);
            OverrideParam("BEZEL_R", (float)0.030000);
            OverrideParam("BEZEL_REFL_STRENGTH", (float)0.300000);
            OverrideParam("BEZEL_REFL_ZOOM", (float)1.000000);
            OverrideParam("BEZEL_RFL_BLR_SHD", (float)-0.400000);
            ...
            OverrideParam("BG_IMAGE_OFFX", (float)0.001000);
            OverrideParam("BG_IMAGE_OFFY", (float)0.001000);
            OverrideParam("BG_IMAGE_OVER", (float)1.000000);
            OverrideParam("BG_IMAGE_ZOOM", (float)1.110503);
            ...
            OverrideParam("GAMMA_OUT", (float)0.430000);
            OverrideParam("GLOBAL_OFFX", (float)0.000000);
            OverrideParam("GLOBAL_OFFY", (float)0.005500);
            OverrideParam("GLOBAL_ZOOM", (float)0.721996);
            ...
            OverrideParam("IN_GLOW_POWER", (float)1.300000);
            ...
            OverrideParam("PIXELGRID_GAMMA_H", (float)4.200000);
            ...
            OverrideParam("PIXELGRID_OFFSET_CORE", (float)0.120000);
