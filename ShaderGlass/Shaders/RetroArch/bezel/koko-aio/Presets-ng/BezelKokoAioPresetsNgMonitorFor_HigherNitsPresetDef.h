...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorFor_HigherNitsPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorFor_HigherNitsPresetDef() : PresetDef{}
	{
		Name = "Monitor-for_HigherNits";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("DO_PIXELGRID_W", (float)0.800000);
            ...
            OverrideParam("S_POWER", (float)0.030000);
