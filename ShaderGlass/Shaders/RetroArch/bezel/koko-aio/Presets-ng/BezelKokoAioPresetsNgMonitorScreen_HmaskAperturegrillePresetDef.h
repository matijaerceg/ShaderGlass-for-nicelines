/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Aperturegrille imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Aperturegrille.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskAperturegrillePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskAperturegrillePresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Aperturegrille";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("HALO_GAMMA", (float)1.800000);
            ...
            OverrideParam("IN_GLOW_W", (float)-0.750000);
            ...
            OverrideParam("PIXELGRID_GAMMA_H", (float)5.199999);
            OverrideParam("PIXELGRID_GAMMA_W", (float)1.500006);
            OverrideParam("PIXELGRID_H_PRST", (float)1.000000);
            OverrideParam("PIXELGRID_MAX_H", (float)1.000000);
            OverrideParam("PIXELGRID_MAX_W", (float)0.400001);
