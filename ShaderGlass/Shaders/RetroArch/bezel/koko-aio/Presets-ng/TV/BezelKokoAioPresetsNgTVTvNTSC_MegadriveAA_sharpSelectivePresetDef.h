/*
ShaderGlass preset bezel/koko-aio / Tv-NTSC_Megadrive-AA_sharp-Selective imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/TV/Tv-NTSC_Megadrive-AA_sharp-Selective.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgTVTvNTSC_MegadriveAA_sharpSelectivePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgTVTvNTSC_MegadriveAA_sharpSelectivePresetDef() : PresetDef{}
	{
		Name = "Tv-NTSC_Megadrive-AA_sharp-Selective";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("NTSC_MIX", (float)0.300000);
            ...
            OverrideParam("WTFL_SHARPNESS_X", (float)0.500000);
