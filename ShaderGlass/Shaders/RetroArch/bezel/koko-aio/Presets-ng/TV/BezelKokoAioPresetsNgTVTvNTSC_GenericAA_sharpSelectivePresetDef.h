/*
ShaderGlass preset bezel/koko-aio / Tv-NTSC_Generic-AA_sharp-Selective imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/TV/Tv-NTSC_Generic-AA_sharp-Selective.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgTVTvNTSC_GenericAA_sharpSelectivePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgTVTvNTSC_GenericAA_sharpSelectivePresetDef() : PresetDef{}
	{
		Name = "Tv-NTSC_Generic-AA_sharp-Selective";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_POWER", (float)1.450000);
            ...
            OverrideParam("DO_WTFL", (float)1.000000);
            OverrideParam("GAMMA_OUT", (float)0.400000);
            OverrideParam("GLOBAL_ZOOM", (float)0.991500);
            OverrideParam("HALO_GAMMA", (float)1.300000);
            OverrideParam("HALO_GAMMA_OUT", (float)1.000000);
            OverrideParam("HALO_NO_PREGAIN", (float)0.000000);
            OverrideParam("HALO_POWER", (float)0.500000);
            OverrideParam("HALO_SHARPNESS", (float)7.000000);
            OverrideParam("HALO_VS_SCAN", (float)0.900000);
            OverrideParam("IN_GLOW_GAMMA", (float)2.000000);
            OverrideParam("IN_GLOW_H", (float)7.000000);
            OverrideParam("IN_GLOW_POWER", (float)1.400000);
            OverrideParam("IN_GLOW_W", (float)7.000000);
            OverrideParam("LUMINANCE", (float)0.100000);
            OverrideParam("NTSC_ARTF_NOBLUR", (float)0.000000);
            OverrideParam("NTSC_ARTF_TRSH", (float)0.150000);
            OverrideParam("NTSC_ARTF_ZAP", (float)0.500000);
            OverrideParam("NTSC_FILTER_FC", (float)2.500000);
            OverrideParam("NTSC_FILTER_SCF", (float)1.000000);
            OverrideParam("NTSC_FILTER_WIDTH", (float)13.000000);
            OverrideParam("NTSC_MIX", (float)0.500000);
            OverrideParam("NTSC_PHASE_SHIFT", (float)1.000000);
            OverrideParam("OFFSET_STRENGTH", (float)0.300000);
            OverrideParam("PIXELGRID_BASAL_GRID", (float)0.100000);
            OverrideParam("PIXELGRID_DECON_B_H", (float)0.600000);
            OverrideParam("PIXELGRID_DECON_G_H", (float)0.000000);
            OverrideParam("PIXELGRID_DECON_R_H", (float)-0.600000);
            OverrideParam("PIXELGRID_GAMMA_H", (float)5.100000);
            ...
            OverrideParam("PIXELGRID_Y_MASK", (float)0.600000);
            ...
            OverrideParam("PIXELGRID_Y_MASK_STEEP", (float)3.000000);
            OverrideParam("PIXELGRID_Y_SPARK", (float)2.000000);
            ...
            OverrideParam("WTFL_SHARPNESS_X", (float)1.000000);
            OverrideParam("WTFL_SHARPNESS_Y", (float)1.000000);
	}
};
}
