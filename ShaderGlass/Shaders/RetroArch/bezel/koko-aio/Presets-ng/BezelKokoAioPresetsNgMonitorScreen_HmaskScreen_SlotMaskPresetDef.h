...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Screen_SlotMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("PIXELGRID_Y_SPARK", (float)8.000000);
