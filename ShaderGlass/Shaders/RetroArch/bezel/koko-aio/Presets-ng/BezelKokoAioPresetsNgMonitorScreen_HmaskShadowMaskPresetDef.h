/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-ShadowMask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-ShadowMask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskShadowMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskShadowMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-ShadowMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("PIXELGRID_SHADOWMASK_H", (float)1.000000);
            OverrideParam("PIXELGRID_SHADOWMASK_SHIFT", (float)1.000000);
