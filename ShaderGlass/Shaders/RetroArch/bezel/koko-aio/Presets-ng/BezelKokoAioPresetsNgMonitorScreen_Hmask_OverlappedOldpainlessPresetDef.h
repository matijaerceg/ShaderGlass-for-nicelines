/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask_Overlapped-oldpainless imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask_Overlapped-oldpainless.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_Hmask_OverlappedOldpainlessPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_Hmask_OverlappedOldpainlessPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask_Overlapped-oldpainless";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_OVER_WHITE", (float)0.250000);
            OverrideParam("BLOOM_POWER", (float)2.100000);
            ...
            OverrideParam("DO_PIXELGRID_H", (float)0.850000);
            ...
            OverrideParam("IN_GLOW_POWER", (float)1.100000);
            OverrideParam("IN_GLOW_SPREAD", (float)0.000000);
            OverrideParam("IN_GLOW_W", (float)-0.800001);
            ...
            OverrideParam("PIXELGRID_GAMMA_H", (float)8.000000);
            OverrideParam("PIXELGRID_GAMMA_W", (float)2.200000);
            OverrideParam("PIXELGRID_H_PRST", (float)7.000000);
            OverrideParam("PIXELGRID_MAX_H", (float)1.250000);
            OverrideParam("PIXELGRID_MAX_W", (float)0.500000);
            OverrideParam("PIXELGRID_MIN_H", (float)0.450000);
            OverrideParam("PIXELGRID_MIN_W", (float)0.500000);
            OverrideParam("PIXELGRID_NO_INTERBLEED_H", (float)4.000000);
            OverrideParam("PIXELGRID_OFFSET_CORE", (float)0.060000);
            OverrideParam("PIXELGRID_OVERMASK", (float)1.160000);
            ...
            OverrideParam("PIXELGRID_Y_MASK_SHIFT", (float)0.300000);
            ...
            OverrideParam("TEMPERATURE", (float)6900.000000);
