/*
ShaderGlass preset bezel/koko-aio / Vector_neon_4_mame2003plus_defaults imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/VectorGFX/Vector_neon_4_mame2003plus_defaults.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgVectorGFXVector_neon_4_mame2003plus_defaultsPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgVectorGFXVector_neon_4_mame2003plus_defaultsPresetDef() : PresetDef{}
	{
		Name = "Vector_neon_4_mame2003plus_defaults";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BEZEL_CORNER_DARK", (float)1.000000);
            ...
            OverrideParam("BEZEL_REFL_STRENGTH", (float)0.015000);
            ...
            OverrideParam("BLOOM_MIX", (float)0.760000);
            OverrideParam("BLOOM_OVER_WHITE", (float)0.000000);
            OverrideParam("BLOOM_POWER", (float)1.000000);
            OverrideParam("BLOOM_QUALITY", (float)2.000000);
            OverrideParam("BLOOM_SIZE", (float)7.000000);
            OverrideParam("CLIP_TO_WHITE", (float)0.200000);
            ...
            OverrideParam("GAMMA_OUT", (float)0.450001);
            OverrideParam("GLOBAL_ZOOM", (float)0.830492);
            OverrideParam("HALO_GAMMA", (float)2.749998);
            OverrideParam("HALO_POWER", (float)2.000000);
            OverrideParam("HALO_SHARPNESS", (float)7.000000);
            OverrideParam("HALO_VS_SCAN", (float)1.000000);
            OverrideParam("IN_GLOW_GAMMA", (float)2.199999);
            OverrideParam("IN_GLOW_H", (float)1.000000);
            OverrideParam("IN_GLOW_POWER", (float)5.000000);
            OverrideParam("IN_GLOW_SPREAD", (float)4.000000);
            OverrideParam("IN_GLOW_W", (float)1.000000);
            OverrideParam("IN_GLOW_WARPSHARP_GAMMA", (float)0.500000);
