/*
ShaderGlass preset bezel/koko-aio / Monitor-VGA-DoubleScan-ShadowMask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/VGA/Monitor-VGA-DoubleScan-ShadowMask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgVGAMonitorVGADoubleScanShadowMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgVGAMonitorVGADoubleScanShadowMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-VGA-DoubleScan-ShadowMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("DO_PIXELGRID_H", (float)0.600000);
            ...
            OverrideParam("PIXELGRID_DO_SHADOWMASK", (float)1.000000);
            ...
            OverrideParam("S_POWER", (float)0.100000);
            OverrideParam("S_SIZE", (float)1.300000);
