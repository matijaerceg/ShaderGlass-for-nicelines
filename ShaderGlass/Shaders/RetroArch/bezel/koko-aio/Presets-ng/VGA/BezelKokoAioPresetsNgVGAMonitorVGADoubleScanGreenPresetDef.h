/*
ShaderGlass preset bezel/koko-aio / Monitor-VGA-DoubleScan-Green imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/VGA/Monitor-VGA-DoubleScan-Green.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgVGAMonitorVGADoubleScanGreenPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgVGAMonitorVGADoubleScanGreenPresetDef() : PresetDef{}
	{
		Name = "Monitor-VGA-DoubleScan-Green";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("AMBI_OVER_BEZEL", (float)0.000000);
            OverrideParam("AMBI_OVER_BEZEL_SIZE", (float)0.000000);
            OverrideParam("AMBI_POWER", (float)1.800000);
            OverrideParam("AMBI_STEPS", (float)60.000000);
            OverrideParam("ASPECT_X", (float)0.000000);
            OverrideParam("BEZEL_B", (float)0.025000);
            OverrideParam("BEZEL_CON", (float)3.000000);
            OverrideParam("BEZEL_DIFFUSION_STR", (float)0.500000);
            OverrideParam("BEZEL_FRAME_ZOOM", (float)0.179000);
            OverrideParam("BEZEL_G", (float)0.060000);
            OverrideParam("BEZEL_R", (float)0.090000);
            OverrideParam("BEZEL_REFL_STRENGTH", (float)0.350000);
            OverrideParam("BEZEL_REFL_ZOOM", (float)1.000000);
            OverrideParam("BEZEL_RFL_BLR_SHD", (float)-1.500000);
            OverrideParam("BEZEL_RFL_CONTRAST", (float)1.800000);
            OverrideParam("BEZEL_RFL_OFFSET", (float)0.001000);
            OverrideParam("BEZEL_ROUGHNESS", (float)2.000000);
            OverrideParam("BEZEL_SPCL_STRENGTH", (float)0.300000);
            ...
            OverrideParam("BLOOM_GAMMA_OUT", (float)0.500000);
            OverrideParam("BLOOM_MIX", (float)0.110000);
            OverrideParam("BLOOM_OVER_WHITE", (float)0.500000);
            OverrideParam("BLOOM_POWER", (float)1.300000);
            OverrideParam("BLOOM_QUALITY", (float)1.000000);
            OverrideParam("BLOOM_SIZE", (float)2.000000);
            OverrideParam("COLOR_MONO_COLORIZE", (float)1.000000);
            OverrideParam("COLOR_MONO_HUE1", (float)0.410000);
            OverrideParam("COLOR_MONO_HUE2", (float)0.410000);
            OverrideParam("COLOR_MONO_HUE_BIAS", (float)0.010000);
            OverrideParam("CONTRAST", (float)-0.020000);
            ...
            OverrideParam("DO_PIXELGRID_H", (float)0.400000);
            OverrideParam("DO_PIXELGRID_W", (float)0.000000);
            ...
            OverrideParam("IN_GLOW_POWER", (float)1.000000);
            OverrideParam("IN_GLOW_W", (float)7.000000);
            OverrideParam("IN_GLOW_WARPSHARP_X", (float)0.750000);
            OverrideParam("IN_GLOW_WARPSHARP_Y", (float)0.750000);
            ...
            OverrideParam("PIXELGRID_COREY_FAKE_SCAN", (float)-1.000000);
            OverrideParam("PIXELGRID_DOUBLESCAN", (float)1.000000);
            OverrideParam("PIXELGRID_DO_SHADOWMASK", (float)0.000000);
            OverrideParam("PIXELGRID_GAMMA_H", (float)2.200000);
            OverrideParam("PIXELGRID_GAMMA_W", (float)1.500000);
            OverrideParam("PIXELGRID_H_PRST", (float)2.000000);
            OverrideParam("PIXELGRID_INTR_DISABLE_Y", (float)2.000000);
            OverrideParam("PIXELGRID_INTR_FLICK_MODE", (float)0.000000);
            OverrideParam("PIXELGRID_MAX_H", (float)1.000000);
            OverrideParam("PIXELGRID_MAX_W", (float)0.400000);
            ...
            OverrideParam("PIXELGRID_SHADOWMASK_SHIFT", (float)1.500000);
            ...
            OverrideParam("PPERSISTENCE_END", (float)0.500000);
            OverrideParam("PPERSISTENCE_START", (float)0.900000);
            ...
            OverrideParam("S_POWER", (float)0.097000);
