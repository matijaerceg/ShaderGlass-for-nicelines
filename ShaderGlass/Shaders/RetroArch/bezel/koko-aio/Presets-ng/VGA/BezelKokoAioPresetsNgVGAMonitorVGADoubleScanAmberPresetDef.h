/*
ShaderGlass preset bezel/koko-aio / Monitor-VGA-DoubleScan-Amber imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/VGA/Monitor-VGA-DoubleScan-Amber.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgVGAMonitorVGADoubleScanAmberPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgVGAMonitorVGADoubleScanAmberPresetDef() : PresetDef{}
	{
		Name = "Monitor-VGA-DoubleScan-Amber";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("COLOR_MONO_HUE1", (float)0.110000);
            OverrideParam("COLOR_MONO_HUE2", (float)0.110000);
