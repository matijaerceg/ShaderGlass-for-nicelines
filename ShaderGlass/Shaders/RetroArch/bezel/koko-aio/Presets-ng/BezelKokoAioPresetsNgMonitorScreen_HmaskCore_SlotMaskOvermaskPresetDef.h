/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Core_SlotMask-Overmask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Core_SlotMask-Overmask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskCore_SlotMaskOvermaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskCore_SlotMaskOvermaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Core_SlotMask-Overmask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("GAMMA_OUT", (float)0.340000);
            ...
            OverrideParam("HALO_VS_SCAN", (float)0.250000);
            ...
            OverrideParam("IN_GLOW_SPREAD", (float)1.600000);
            ...
            OverrideParam("PIXELGRID_H_ANTIMOIRE", (float)0.170000);
            ...
            OverrideParam("PIXELGRID_OVERMASK", (float)1.500000);
            OverrideParam("PIXELGRID_Y_MASK", (float)0.200000);
            OverrideParam("PIXELGRID_Y_MASK_COORDS", (float)0.000000);
            OverrideParam("PIXELGRID_Y_MASK_HEIGHT", (float)-2.000000);
            OverrideParam("PIXELGRID_Y_MASK_ON_WHITE", (float)0.100000);
            OverrideParam("PIXELGRID_Y_MASK_SHIFT", (float)0.260000);
            OverrideParam("PIXELGRID_Y_MASK_STEEP", (float)16.000000);
            OverrideParam("PIXELGRID_Y_SPARK", (float)0.600000);
