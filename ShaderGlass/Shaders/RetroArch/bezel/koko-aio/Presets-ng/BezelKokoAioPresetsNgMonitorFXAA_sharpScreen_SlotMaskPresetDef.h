/*
ShaderGlass preset bezel/koko-aio / Monitor-FXAA_sharp-Screen_SlotMask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-FXAA_sharp-Screen_SlotMask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorFXAA_sharpScreen_SlotMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorFXAA_sharpScreen_SlotMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-FXAA_sharp-Screen_SlotMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_POWER", (float)3.300000);
            ...
            OverrideParam("DO_DEDITHER", (float)1.000000);
            OverrideParam("DO_DYNZOOM", (float)0.015000);
            OverrideParam("DO_FXAA", (float)1.000000);
            ...
            OverrideParam("PIXELGRID_GAMMA_H", (float)5.199997);
            OverrideParam("PIXELGRID_GAMMA_W", (float)2.200000);
            OverrideParam("PIXELGRID_H_COUNT", (float)2.000000);
            OverrideParam("PIXELGRID_H_PRST", (float)1.000000);
            OverrideParam("PIXELGRID_MAX_H", (float)0.900000);
            OverrideParam("PIXELGRID_MAX_W", (float)0.920000);
            OverrideParam("PIXELGRID_MIN_H", (float)0.250000);
            ...
            OverrideParam("PIXELGRID_Y_MASK", (float)1.000000);
            ...
            OverrideParam("PIXELGRID_Y_SPARK", (float)4.000000);
            OverrideParam("SATURATION", (float)1.080000);
