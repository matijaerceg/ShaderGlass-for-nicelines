/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Screen_SlotMask-Chameleon imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Screen_SlotMask-Chameleon.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMaskChameleonPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMaskChameleonPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Screen_SlotMask-Chameleon";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("AMBI_OVER_BEZEL_SIZE", (float)0.500000);
            OverrideParam("AMBI_STEPS", (float)5.000000);
            OverrideParam("AMBI_STRETCH", (float)0.100000);
            OverrideParam("BEZEL_B", (float)-0.500000);
            OverrideParam("BEZEL_CON", (float)0.870000);
            OverrideParam("BEZEL_CORNER_DARK", (float)0.600000);
            OverrideParam("BEZEL_DIFFUSION_STR", (float)0.600000);
            OverrideParam("BEZEL_FRAME_ZOOM", (float)0.179000);
            OverrideParam("BEZEL_G", (float)-0.500000);
            OverrideParam("BEZEL_LIGHT_NO_FADEOUT", (float)0.500000);
            OverrideParam("BEZEL_R", (float)-0.500000);
            OverrideParam("BEZEL_REFL_STRENGTH", (float)0.400000);
            OverrideParam("BEZEL_RFL_BLR_SHD", (float)-1.500000);
            OverrideParam("BEZEL_SPCL_STRENGTH", (float)0.200000);
            ...
            OverrideParam("IN_GLOW_SPREAD", (float)1.500000);
