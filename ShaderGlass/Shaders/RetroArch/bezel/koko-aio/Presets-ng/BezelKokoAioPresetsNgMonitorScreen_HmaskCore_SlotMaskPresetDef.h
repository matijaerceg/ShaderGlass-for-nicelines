/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Core_SlotMask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Core_SlotMask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskCore_SlotMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskCore_SlotMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Core_SlotMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("GAMMA_OUT", (float)0.385000);
            ...
            OverrideParam("IN_GLOW_POWER", (float)2.150000);
