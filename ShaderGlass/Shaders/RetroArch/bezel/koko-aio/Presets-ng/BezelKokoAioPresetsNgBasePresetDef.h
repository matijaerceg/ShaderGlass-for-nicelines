/*
ShaderGlass preset bezel/koko-aio / Base imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Base.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgBasePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgBasePresetDef() : PresetDef{}
	{
		Name = "Base";
