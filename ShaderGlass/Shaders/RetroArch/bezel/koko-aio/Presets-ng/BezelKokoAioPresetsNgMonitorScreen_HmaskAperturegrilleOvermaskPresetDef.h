...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskAperturegrilleOvermaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskAperturegrilleOvermaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Aperturegrille-Overmask";
