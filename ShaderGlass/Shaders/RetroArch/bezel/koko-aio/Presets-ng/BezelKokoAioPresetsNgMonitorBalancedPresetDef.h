/*
ShaderGlass preset bezel/koko-aio / Monitor-Balanced imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-Balanced.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorBalancedPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorBalancedPresetDef() : PresetDef{}
	{
		Name = "Monitor-Balanced";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("OFFSET_STRENGTH", (float)0.400000);
            ...
            OverrideParam("PIXELGRID_Y_SPARK", (float)6.000000);
