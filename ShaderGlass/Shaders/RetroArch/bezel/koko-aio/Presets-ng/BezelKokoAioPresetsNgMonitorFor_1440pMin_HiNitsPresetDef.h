/*
ShaderGlass preset bezel/koko-aio / Monitor-for_1440pMin_HiNits imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets-ng/Monitor-for_1440pMin_HiNits.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorFor_1440pMin_HiNitsPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorFor_1440pMin_HiNitsPresetDef() : PresetDef{}
	{
		Name = "Monitor-for_1440pMin_HiNits";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("IN_GLOW_H", (float)2.000000);
            ...
            OverrideParam("PIXELGRID_MAX_H", (float)0.800000);
            OverrideParam("PIXELGRID_MAX_W", (float)0.460000);
            OverrideParam("PIXELGRID_MIN_H", (float)0.700000);
            OverrideParam("PIXELGRID_MIN_W", (float)0.300000);
            ...
            OverrideParam("PIXELGRID_Y_MASK_HEIGHT", (float)0.500000);
            OverrideParam("PIXELGRID_Y_MASK_ON_WHITE", (float)0.000000);
            OverrideParam("PIXELGRID_Y_MASK_SHIFT", (float)0.120000);
