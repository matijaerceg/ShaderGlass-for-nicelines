...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyColorOverlayTallerPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyColorOverlayTallerPresetDef() : PresetDef{}
	{
		Name = "GameboyColor-Overlay-Taller";
