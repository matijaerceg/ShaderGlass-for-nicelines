...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyPocketOverlayTallerPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyPocketOverlayTallerPresetDef() : PresetDef{}
	{
		Name = "GameboyPocket-Overlay-Taller";
