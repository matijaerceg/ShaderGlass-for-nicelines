/*
ShaderGlass preset bezel/koko-aio / PSP-Overlay-Night-Small-Y_flip imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/PSP-Overlay-Night-Small-Y_flip.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgPSPOverlayNightSmallY_flipPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgPSPOverlayNightSmallY_flipPresetDef() : PresetDef{}
	{
		Name = "PSP-Overlay-Night-Small-Y_flip";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BG_IMAGE_ZOOM", (float)1.048996);
            ...
            OverrideParam("GLOBAL_OFFY", (float)-0.030000);
            OverrideParam("GLOBAL_ZOOM", (float)0.597001);
