/*
ShaderGlass preset bezel/koko-aio / PSP-Overlay-Night-Big- Y_flip imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/PSP-Overlay-Night-Big- Y_flip.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgPSPOverlayNightBigY_flipPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgPSPOverlayNightBigY_flipPresetDef() : PresetDef{}
	{
		Name = "PSP-Overlay-Night-Big- Y_flip";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("ASPECT_X", (float)256.000000);
            OverrideParam("ASPECT_Y", (float)146.000000);
            OverrideParam("BG_IMAGE_NIGHTIFY", (float)0.800000);
            OverrideParam("BG_IMAGE_OFFX", (float)0.000500);
            OverrideParam("BG_IMAGE_ROTATION", (float)0.000000);
            OverrideParam("BG_IMAGE_WRAP_MODE", (float)1.000000);
            OverrideParam("BG_IMAGE_ZOOM", (float)1.300000);
            ...
            OverrideParam("GLOBAL_OFFX", (float)-0.000650);
            OverrideParam("GLOBAL_OFFY", (float)-0.036250);
            OverrideParam("GLOBAL_ZOOM", (float)0.740000);
