/*
ShaderGlass preset bezel/koko-aio / GameboyColor-Overlay-Taller-IPS imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/GameboyColor-Overlay-Taller-IPS.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyColorOverlayTallerIPSPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyColorOverlayTallerIPSPresetDef() : PresetDef{}
	{
		Name = "GameboyColor-Overlay-Taller-IPS";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BG_IMAGE_OFFY", (float)-0.183499);
            ...
            OverrideParam("DOT_M_G_SHARP", (float)1.000000);
            ...
            OverrideParam("GAME_GEOM_VSHIFT", (float)0.000000);
