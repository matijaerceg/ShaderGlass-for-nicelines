/*
ShaderGlass preset bezel/koko-aio / GameboyAdvance-Overlay-Night imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/GameboyAdvance-Overlay-Night.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyAdvanceOverlayNightPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyAdvanceOverlayNightPresetDef() : PresetDef{}
	{
		Name = "GameboyAdvance-Overlay-Night";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("AMBI_FALLOFF", (float)0.600000);
