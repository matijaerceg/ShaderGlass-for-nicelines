/*
ShaderGlass preset bezel/koko-aio / PSP-Overlay-Night-Big imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/PSP-Overlay-Night-Big.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgPSPOverlayNightBigPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgPSPOverlayNightBigPresetDef() : PresetDef{}
	{
		Name = "PSP-Overlay-Night-Big";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("GLOBAL_OFFY", (float)0.035750);
