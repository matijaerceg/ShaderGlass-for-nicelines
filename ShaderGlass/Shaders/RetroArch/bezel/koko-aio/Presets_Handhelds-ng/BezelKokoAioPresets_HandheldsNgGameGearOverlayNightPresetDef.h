/*
ShaderGlass preset bezel/koko-aio / GameGear-Overlay-Night imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/GameGear-Overlay-Night.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameGearOverlayNightPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameGearOverlayNightPresetDef() : PresetDef{}
	{
		Name = "GameGear-Overlay-Night";
...
.Param("wrap_mode", "clamp_to_edge"));
            TextureDefs.push_back(BezelKokoAioTexturesOverlaysGamegearTextureDef()
.Param("linear", "true")
.Param("mipmap", "false")
.Param("name", "bg_under")
.Param("wrap_mode", "mirrored_repeat"));
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("AMBI_GAMMA", (float)2.999999);
            OverrideParam("AMBI_POWER", (float)1.800000);
            OverrideParam("AMBI_STEPS", (float)5.000000);
            OverrideParam("AMBI_STRETCH", (float)0.750000);
            ...
            OverrideParam("DO_PIXELGRID_H", (float)0.500000);
            ...
            OverrideParam("GLOBAL_OFFX", (float)-0.013000);
