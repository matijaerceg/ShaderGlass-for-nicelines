...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyMonoOverlayTallerPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyMonoOverlayTallerPresetDef() : PresetDef{}
	{
		Name = "GameboyMono-Overlay-Taller";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("GLOBAL_OFFY", (float)-0.174000);
            OverrideParam("GLOBAL_ZOOM", (float)0.380000);
