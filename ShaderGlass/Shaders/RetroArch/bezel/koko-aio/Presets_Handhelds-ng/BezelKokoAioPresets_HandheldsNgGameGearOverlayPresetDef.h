...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameGearOverlayPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameGearOverlayPresetDef() : PresetDef{}
	{
		Name = "GameGear-Overlay";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BG_IMAGE_NIGHTIFY", (float)0.200000);
