/*
ShaderGlass preset bezel/koko-aio / GameboyMono-Overlay imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/bezel/koko-aio/Presets_Handhelds-ng/GameboyMono-Overlay.slangp
...
namespace RetroArch
{
class BezelKokoAioPresets_HandheldsNgGameboyMonoOverlayPresetDef : public PresetDef
{
public:
	BezelKokoAioPresets_HandheldsNgGameboyMonoOverlayPresetDef() : PresetDef{}
	{
		Name = "GameboyMono-Overlay";
...
.Param("wrap_mode", "clamp_to_edge"));
            TextureDefs.push_back(BezelKokoAioTexturesOverlaysGbmTextureDef()
.Param("linear", "true")
.Param("mipmap", "false")
.Param("name", "bg_under")
.Param("wrap_mode", "mirrored_repeat"));
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BG_IMAGE_ZOOM", (float)2.050000);
            OverrideParam("BRIGHTNESS", (float)0.030000);
            ...
            OverrideParam("GLOBAL_OFFY", (float)-0.008000);
            OverrideParam("GLOBAL_ZOOM", (float)0.574004);
