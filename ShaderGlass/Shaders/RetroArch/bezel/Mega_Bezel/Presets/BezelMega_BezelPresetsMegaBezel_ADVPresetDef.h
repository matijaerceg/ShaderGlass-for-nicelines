/*
ShaderGlass preset bezel / MegaBezel_ADV imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsMegaBezel_ADVPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsMegaBezel_ADVPresetDef() : PresetDef{}
	{
		Name = "MegaBezel_ADV";
		Category = "bezel";
	}
