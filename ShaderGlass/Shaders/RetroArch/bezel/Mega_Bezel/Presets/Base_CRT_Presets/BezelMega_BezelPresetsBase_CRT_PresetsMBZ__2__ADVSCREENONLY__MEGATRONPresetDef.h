/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-SCREEN-ONLY__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLY__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLY__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-SCREEN-ONLY__MEGATRON";
