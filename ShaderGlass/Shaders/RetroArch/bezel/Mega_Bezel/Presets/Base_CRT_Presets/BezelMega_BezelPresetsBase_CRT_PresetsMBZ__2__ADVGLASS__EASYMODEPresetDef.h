/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-GLASS__EASYMODE imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVGLASS__EASYMODEPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVGLASS__EASYMODEPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-GLASS__EASYMODE";
