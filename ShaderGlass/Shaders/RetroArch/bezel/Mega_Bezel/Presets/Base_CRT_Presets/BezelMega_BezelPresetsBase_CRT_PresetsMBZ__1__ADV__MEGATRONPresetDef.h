/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__1__ADV__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__1__ADV__MEGATRON";
