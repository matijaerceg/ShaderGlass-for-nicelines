/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__4__STD-NO-REFLECT__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDNOREFLECT__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDNOREFLECT__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__4__STD-NO-REFLECT__LCD-GRID";
...
.Param("float_framebuffer", "true"));
         	ShaderDefs.push_back(BezelMega_BezelShadersLcdCgwgHsmLcdGridV2NoReflectShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
