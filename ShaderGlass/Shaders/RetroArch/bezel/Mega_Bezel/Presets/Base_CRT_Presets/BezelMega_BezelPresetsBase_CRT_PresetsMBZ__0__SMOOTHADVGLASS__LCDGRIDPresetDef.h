/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-GLASS__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-GLASS__LCD-GRID";
