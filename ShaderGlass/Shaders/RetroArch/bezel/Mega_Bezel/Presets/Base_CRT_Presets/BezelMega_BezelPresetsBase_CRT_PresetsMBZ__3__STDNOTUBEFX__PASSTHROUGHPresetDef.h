/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD-NO-TUBE-FX__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDNOTUBEFX__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDNOTUBEFX__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD-NO-TUBE-FX__PASSTHROUGH";
