/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-NO-REFLECT__GDV imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__GDVPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__GDVPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-NO-REFLECT__GDV";
