/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__EASYMODE imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__EASYMODEPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__EASYMODEPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__EASYMODE";
