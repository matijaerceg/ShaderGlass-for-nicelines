/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD-GLASS__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD-GLASS__LCD-GRID";
