/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-NO-REFLECT__MEGATRON-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__MEGATRONNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__MEGATRONNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-NO-REFLECT__MEGATRON-NTSC";
...
.Param("float_framebuffer", "true")
.Param("scale_type", "viewport"));
         	ShaderDefs.push_back(BezelMega_BezelShadersBaseCombinePassesNoReflectHdrShaderDef()
