/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-SCREEN-ONLY-NO-TUBE-FX__GDV imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLYNOTUBEFX__GDVPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLYNOTUBEFX__GDVPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-SCREEN-ONLY-NO-TUBE-FX__GDV";
