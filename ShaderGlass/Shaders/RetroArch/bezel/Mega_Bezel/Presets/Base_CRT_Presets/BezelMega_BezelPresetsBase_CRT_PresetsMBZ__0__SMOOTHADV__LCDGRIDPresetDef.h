/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADV__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADV__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV__LCD-GRID";
...
.Param("float_framebuffer", "true"));
         	ShaderDefs.push_back(BezelMega_BezelShadersLcdCgwgHsmLcdGridV2ShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
...
.Param("name", "TopLayerImage"));
            ...
            OverrideParam("HSM_CORE_RES_SAMPLING_MULT_SCANLINE_DIR", (float)100.000000);
            ...
            OverrideParam("HSM_REFLECT_GLOBAL_AMOUNT", (float)20.000000);
            OverrideParam("HSM_SCALEFX_ON", (float)1.000000);
            OverrideParam("SGPT_BLEND_OPTION", (float)1.000000);
            OverrideParam("shadowMask", (float)3.000000);
	}
};
}
