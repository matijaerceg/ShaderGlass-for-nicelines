/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__1__ADV__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__1__ADV__LCD-GRID";
