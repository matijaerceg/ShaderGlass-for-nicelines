/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__PASSTHROUGH";
