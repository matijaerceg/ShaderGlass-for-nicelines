/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-GLASS__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-GLASS__MEGATRON";
