/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__5__POTATO__EASYMODE imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__EASYMODEPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__EASYMODEPresetDef() : PresetDef{}
	{
		Name = "MBZ__5__POTATO__EASYMODE";
