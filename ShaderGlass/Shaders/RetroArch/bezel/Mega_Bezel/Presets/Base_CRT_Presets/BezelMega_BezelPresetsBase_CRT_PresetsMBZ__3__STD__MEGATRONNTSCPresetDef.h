/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__MEGATRON-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__MEGATRONNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__MEGATRONNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__MEGATRON-NTSC";
