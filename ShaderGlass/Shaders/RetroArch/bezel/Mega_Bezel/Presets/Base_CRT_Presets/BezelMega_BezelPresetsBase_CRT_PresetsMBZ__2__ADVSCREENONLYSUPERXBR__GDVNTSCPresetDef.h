/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-SCREEN-ONLY-SUPER-XBR__GDV-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLYSUPERXBR__GDVNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLYSUPERXBR__GDVNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-SCREEN-ONLY-SUPER-XBR__GDV-NTSC";
...
.Param("scale_x", "640.0")
.Param("scale_y", "480.0"));
         	ShaderDefs.push_back(BezelMega_BezelShadersGuestHsmCrtGuestAdvancedNtscPass2NoReflectShaderDef()
.Param("filter_linear", "true")
.Param("float_framebuffer", "true")
