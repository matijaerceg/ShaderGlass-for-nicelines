/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__GDV-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__GDVNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__GDVNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__GDV-NTSC";
