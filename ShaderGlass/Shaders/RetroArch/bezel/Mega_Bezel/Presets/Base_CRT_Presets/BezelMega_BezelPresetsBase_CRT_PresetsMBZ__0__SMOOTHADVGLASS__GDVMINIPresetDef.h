/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-GLASS__GDV-MINI imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__GDVMINIPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__GDVMINIPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-GLASS__GDV-MINI";
