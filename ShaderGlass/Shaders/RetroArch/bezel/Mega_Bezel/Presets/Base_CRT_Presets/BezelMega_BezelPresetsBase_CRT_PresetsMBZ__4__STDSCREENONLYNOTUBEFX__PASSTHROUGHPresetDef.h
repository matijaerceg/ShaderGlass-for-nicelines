/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__4__STD-SCREEN-ONLY-NO-TUBE-FX__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDSCREENONLYNOTUBEFX__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDSCREENONLYNOTUBEFX__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__4__STD-SCREEN-ONLY-NO-TUBE-FX__PASSTHROUGH";
...
.Param("scale_x", "1.0")
.Param("scale_y", "1.0"));
         	ShaderDefs.push_back(BezelMega_BezelShadersBaseLinearizeShaderDef()
.Param("alias", "LinearizePass")
.Param("filter_linear", "true")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
.Param("scale_type", "source"));
         	ShaderDefs.push_back(BezelMega_BezelShadersGuestExtrasHsmScreenScaleGSharp_resamplerNoReflectShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
.Param("scale_type", "viewport"));
         	ShaderDefs.push_back(BezelMega_BezelShadersBasePostCrtPrepMinimumNoReflectShaderDef()
