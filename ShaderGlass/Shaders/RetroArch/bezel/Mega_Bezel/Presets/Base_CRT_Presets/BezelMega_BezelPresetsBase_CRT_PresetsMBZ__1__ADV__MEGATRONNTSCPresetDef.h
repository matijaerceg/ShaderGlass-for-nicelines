/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__1__ADV__MEGATRON-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__MEGATRONNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__MEGATRONNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__1__ADV__MEGATRON-NTSC";
