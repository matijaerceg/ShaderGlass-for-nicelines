/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-GLASS__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVGLASS__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVGLASS__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-GLASS__MEGATRON";
