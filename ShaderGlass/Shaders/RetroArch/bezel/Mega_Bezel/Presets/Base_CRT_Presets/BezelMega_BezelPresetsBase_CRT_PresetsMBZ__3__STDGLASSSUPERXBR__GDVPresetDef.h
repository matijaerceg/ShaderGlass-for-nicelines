/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD-GLASS-SUPER-XBR__GDV imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASSSUPERXBR__GDVPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASSSUPERXBR__GDVPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD-GLASS-SUPER-XBR__GDV";
