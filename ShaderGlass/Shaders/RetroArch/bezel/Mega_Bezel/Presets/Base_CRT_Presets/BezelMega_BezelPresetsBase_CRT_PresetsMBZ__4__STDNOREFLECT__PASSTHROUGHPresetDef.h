/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__4__STD-NO-REFLECT__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDNOREFLECT__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDNOREFLECT__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__4__STD-NO-REFLECT__PASSTHROUGH";
