/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD-GLASS__GDV-MINI-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__GDVMININTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__GDVMININTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD-GLASS__GDV-MINI-NTSC";
