...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVNOREFLECT__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVNOREFLECT__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-NO-REFLECT__MEGATRON";
