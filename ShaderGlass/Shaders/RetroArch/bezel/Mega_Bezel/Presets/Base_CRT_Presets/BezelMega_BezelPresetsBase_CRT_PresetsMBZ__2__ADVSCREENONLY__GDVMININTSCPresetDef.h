/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-SCREEN-ONLY__GDV-MINI-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLY__GDVMININTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVSCREENONLY__GDVMININTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-SCREEN-ONLY__GDV-MINI-NTSC";
