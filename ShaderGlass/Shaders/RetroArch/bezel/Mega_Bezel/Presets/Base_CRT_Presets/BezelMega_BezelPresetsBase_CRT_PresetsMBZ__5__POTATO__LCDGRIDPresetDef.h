/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__5__POTATO__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__5__POTATO__LCD-GRID";
...
.Param("float_framebuffer", "true"));
         	ShaderDefs.push_back(BezelMega_BezelShadersLcdCgwgHsmLcdGridV2PotatoShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
