/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-NO-REFLECT__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVNOREFLECT__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-NO-REFLECT__MEGATRON";
