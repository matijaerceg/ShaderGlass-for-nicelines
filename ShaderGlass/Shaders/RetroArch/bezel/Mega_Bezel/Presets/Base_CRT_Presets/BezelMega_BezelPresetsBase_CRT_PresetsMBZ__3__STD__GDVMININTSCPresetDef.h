/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__GDV-MINI-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__GDVMININTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__GDVMININTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__GDV-MINI-NTSC";
