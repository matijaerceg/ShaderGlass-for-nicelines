/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__LCD-GRID imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__LCDGRIDPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__LCDGRIDPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__LCD-GRID";
