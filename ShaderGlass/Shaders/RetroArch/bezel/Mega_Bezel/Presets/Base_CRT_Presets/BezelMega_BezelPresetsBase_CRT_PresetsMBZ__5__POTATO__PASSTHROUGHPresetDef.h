/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__5__POTATO__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__5__POTATO__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__5__POTATO__PASSTHROUGH";
...
.Param("scale", "1.0")
.Param("scale_type", "source"));
         	ShaderDefs.push_back(BezelMega_BezelShadersGuestExtrasHsmScreenScaleGSharp_resamplerPotatoShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
...
.Param("name", "BackgroundVertImage"));
            ...
            OverrideParam("HSM_FXAA_ON", (float)0.000000);
            OverrideParam("HSM_SCREEN_SCALE_GSHARP_MODE", (float)1.000000);
	}
};
}
