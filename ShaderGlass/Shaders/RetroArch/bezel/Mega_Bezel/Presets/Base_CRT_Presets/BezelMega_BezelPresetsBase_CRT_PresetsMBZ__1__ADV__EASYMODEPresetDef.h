/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__1__ADV__EASYMODE imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__EASYMODEPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__1__ADV__EASYMODEPresetDef() : PresetDef{}
	{
		Name = "MBZ__1__ADV__EASYMODE";
