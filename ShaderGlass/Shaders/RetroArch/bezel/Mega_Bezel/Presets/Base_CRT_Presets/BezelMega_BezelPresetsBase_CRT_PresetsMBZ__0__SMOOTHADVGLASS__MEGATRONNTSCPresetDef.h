/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__0__SMOOTH-ADV-GLASS__MEGATRON-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__MEGATRONNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__0__SMOOTHADVGLASS__MEGATRONNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__0__SMOOTH-ADV-GLASS__MEGATRON-NTSC";
