/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD-GLASS__PASSTHROUGH imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__PASSTHROUGHPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STDGLASS__PASSTHROUGHPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD-GLASS__PASSTHROUGH";
...
.Param("scale", "1.0")
.Param("scale_type", "source"));
         	ShaderDefs.push_back(BezelMega_BezelShadersGuestExtrasHsmScreenScaleGSharp_resamplerShaderDef()
.Param("alias", "CRTPass")
.Param("filter_linear", "false")
.Param("float_framebuffer", "true")
.Param("scale", "1.0")
.Param("scale_type", "viewport"));
         	ShaderDefs.push_back(BezelMega_BezelShadersBasePostCrtPrepMinimumGlassShaderDef()
