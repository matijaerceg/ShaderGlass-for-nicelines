/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__4__STD-SCREEN-ONLY__GDV-MINI-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDSCREENONLY__GDVMININTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__4__STDSCREENONLY__GDVMININTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__4__STD-SCREEN-ONLY__GDV-MINI-NTSC";
