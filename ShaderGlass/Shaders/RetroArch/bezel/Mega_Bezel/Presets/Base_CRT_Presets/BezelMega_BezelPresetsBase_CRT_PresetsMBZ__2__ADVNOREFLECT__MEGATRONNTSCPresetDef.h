/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__2__ADV-NO-REFLECT__MEGATRON-NTSC imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVNOREFLECT__MEGATRONNTSCPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__2__ADVNOREFLECT__MEGATRONNTSCPresetDef() : PresetDef{}
	{
		Name = "MBZ__2__ADV-NO-REFLECT__MEGATRON-NTSC";
