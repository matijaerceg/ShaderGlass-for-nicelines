/*
ShaderGlass preset bezel/Mega_Bezel_Base / MBZ__3__STD__MEGATRON imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__MEGATRONPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsBase_CRT_PresetsMBZ__3__STD__MEGATRONPresetDef() : PresetDef{}
	{
		Name = "MBZ__3__STD__MEGATRON";
