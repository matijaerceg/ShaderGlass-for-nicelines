/*
ShaderGlass preset bezel / MegaBezel_ADV-GLASS imported from MegaBezel:
...
namespace RetroArch
{
class BezelMega_BezelPresetsMegaBezel_ADVGLASSPresetDef : public PresetDef
{
public:
	BezelMega_BezelPresetsMegaBezel_ADVGLASSPresetDef() : PresetDef{}
	{
		Name = "MegaBezel_ADV-GLASS";
		Category = "bezel";
	}
