/*
ShaderGlass preset handheld / gameboy-pocket imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/handheld/gameboy-pocket.slangp
...
namespace RetroArch
{
class HandheldGameboyPocketPresetDef : public PresetDef
{
public:
	HandheldGameboyPocketPresetDef() : PresetDef{}
	{
		Name = "gameboy-pocket";
		Category = "handheld";
	}
