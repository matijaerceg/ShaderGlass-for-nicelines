/*
ShaderGlass preset retro-crisis/1080p-Flat / RC GDV-NTSC - Arcade RGB imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pFlatRCGDVNTSCArcadeRGBPresetDef : public PresetDef
{
public:
	RetroCrisis1080pFlatRCGDVNTSCArcadeRGBPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Arcade RGB";
		Category = "retro-crisis/1080p-Flat";
	}
