/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - Arcade RGB imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCArcadeRGBPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCArcadeRGBPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Arcade RGB";
		Category = "retro-crisis/1440p-Curved";
	}
