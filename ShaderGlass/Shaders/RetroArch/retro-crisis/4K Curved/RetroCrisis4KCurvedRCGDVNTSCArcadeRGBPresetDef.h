/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Arcade RGB imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCArcadeRGBPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCArcadeRGBPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Arcade RGB";
		Category = "retro-crisis/4K-Curved";
	}
