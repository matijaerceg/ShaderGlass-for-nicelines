/*
ShaderGlass preset presets / crt-royale-downsample imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-downsample.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleDownsamplePresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleDownsamplePresetDef() : PresetDef{}
	{
		Name = "crt-royale-downsample";
		Category = "presets";
	}
