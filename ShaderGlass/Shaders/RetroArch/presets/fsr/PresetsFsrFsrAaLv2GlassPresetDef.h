/*
ShaderGlass preset presets/fsr / fsr-aa-lv2-glass imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/fsr/fsr-aa-lv2-glass.slangp
...
namespace RetroArch
{
class PresetsFsrFsrAaLv2GlassPresetDef : public PresetDef
{
public:
	PresetsFsrFsrAaLv2GlassPresetDef() : PresetDef{}
	{
		Name = "fsr-aa-lv2-glass";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("g_reflstr", (float)0.700000);
