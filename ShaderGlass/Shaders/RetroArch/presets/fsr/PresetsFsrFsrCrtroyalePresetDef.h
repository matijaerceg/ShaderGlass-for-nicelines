/*
ShaderGlass preset presets/fsr / fsr-crtroyale imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/fsr/fsr-crtroyale.slangp
...
namespace RetroArch
{
class PresetsFsrFsrCrtroyalePresetDef : public PresetDef
{
public:
	PresetsFsrFsrCrtroyalePresetDef() : PresetDef{}
	{
		Name = "fsr-crtroyale";
