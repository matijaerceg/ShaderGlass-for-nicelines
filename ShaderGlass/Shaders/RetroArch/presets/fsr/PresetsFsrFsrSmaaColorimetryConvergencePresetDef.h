/*
ShaderGlass preset presets/fsr / fsr-smaa-colorimetry-convergence imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/fsr/fsr-smaa-colorimetry-convergence.slangp
...
namespace RetroArch
{
class PresetsFsrFsrSmaaColorimetryConvergencePresetDef : public PresetDef
{
public:
	PresetsFsrFsrSmaaColorimetryConvergencePresetDef() : PresetDef{}
	{
		Name = "fsr-smaa-colorimetry-convergence";
