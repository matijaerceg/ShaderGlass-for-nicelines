/*
ShaderGlass preset presets/crt-ntsc-sharp / composite imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-ntsc-sharp/composite.slangp
...
namespace RetroArch
{
class PresetsCrtNtscSharpCompositePresetDef : public PresetDef
{
public:
	PresetsCrtNtscSharpCompositePresetDef() : PresetDef{}
	{
		Name = "composite";
