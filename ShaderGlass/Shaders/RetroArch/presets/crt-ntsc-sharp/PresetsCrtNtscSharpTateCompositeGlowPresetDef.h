/*
ShaderGlass preset presets/crt-ntsc-sharp / tate-composite-glow imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-ntsc-sharp/tate-composite-glow.slangp
...
namespace RetroArch
{
class PresetsCrtNtscSharpTateCompositeGlowPresetDef : public PresetDef
{
public:
	PresetsCrtNtscSharpTateCompositeGlowPresetDef() : PresetDef{}
	{
		Name = "tate-composite-glow";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("SM_PWR", (float)0.700000);
