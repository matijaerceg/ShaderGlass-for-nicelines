/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-pvm-ntsc-composite-genesis-rainbow-effect imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-pvm-ntsc-composite-genesis-rainbow-effect.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyalePvmNtscCompositeGenesisRainbowEffectPresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyalePvmNtscCompositeGenesisRainbowEffectPresetDef() : PresetDef{}
	{
		Name = "crt-royale-pvm-ntsc-composite-genesis-rainbow-effect";
