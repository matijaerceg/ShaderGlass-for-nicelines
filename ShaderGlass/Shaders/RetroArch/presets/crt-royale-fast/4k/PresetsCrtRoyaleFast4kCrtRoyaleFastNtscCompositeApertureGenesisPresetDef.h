/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-fast-ntsc-composite-aperture-genesis imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-fast-ntsc-composite-aperture-genesis.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyaleFastNtscCompositeApertureGenesisPresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyaleFastNtscCompositeApertureGenesisPresetDef() : PresetDef{}
	{
		Name = "crt-royale-fast-ntsc-composite-aperture-genesis";
