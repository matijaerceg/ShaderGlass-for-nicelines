/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-fast-ntsc-composite-slotmask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-fast-ntsc-composite-slotmask.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyaleFastNtscCompositeSlotmaskPresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyaleFastNtscCompositeSlotmaskPresetDef() : PresetDef{}
	{
		Name = "crt-royale-fast-ntsc-composite-slotmask";
