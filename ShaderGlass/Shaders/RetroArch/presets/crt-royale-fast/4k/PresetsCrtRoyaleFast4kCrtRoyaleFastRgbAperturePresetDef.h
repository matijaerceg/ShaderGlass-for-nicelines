/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-fast-rgb-aperture imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-fast-rgb-aperture.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyaleFastRgbAperturePresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyaleFastRgbAperturePresetDef() : PresetDef{}
	{
		Name = "crt-royale-fast-rgb-aperture";
