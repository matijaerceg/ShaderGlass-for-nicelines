/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-pvm-ntsc-composite-snes imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-pvm-ntsc-composite-snes.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyalePvmNtscCompositeSnesPresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyalePvmNtscCompositeSnesPresetDef() : PresetDef{}
	{
		Name = "crt-royale-pvm-ntsc-composite-snes";
