/*
ShaderGlass preset presets/crt-royale-fast/4k / crt-royale-pvm-rgb-blend imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-royale-fast/4k/crt-royale-pvm-rgb-blend.slangp
...
namespace RetroArch
{
class PresetsCrtRoyaleFast4kCrtRoyalePvmRgbBlendPresetDef : public PresetDef
{
public:
	PresetsCrtRoyaleFast4kCrtRoyalePvmRgbBlendPresetDef() : PresetDef{}
	{
		Name = "crt-royale-pvm-rgb-blend";
...
.Param("wrap_mode", "repeat"));
            OverrideParam("beam_horiz_filter", (float)2.000000);
