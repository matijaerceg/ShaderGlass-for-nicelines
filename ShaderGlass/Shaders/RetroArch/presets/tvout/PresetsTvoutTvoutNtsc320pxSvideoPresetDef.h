/*
ShaderGlass preset presets/tvout / tvout+ntsc-320px-svideo imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/tvout/tvout+ntsc-320px-svideo.slangp
...
namespace RetroArch
{
class PresetsTvoutTvoutNtsc320pxSvideoPresetDef : public PresetDef
{
public:
	PresetsTvoutTvoutNtsc320pxSvideoPresetDef() : PresetDef{}
	{
		Name = "tvout+ntsc-320px-svideo";
