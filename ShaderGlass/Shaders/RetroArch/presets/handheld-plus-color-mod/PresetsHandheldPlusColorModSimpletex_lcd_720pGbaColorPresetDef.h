/*
ShaderGlass preset presets/handheld-plus-color-mod / simpletex_lcd_720p+gba-color imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/handheld-plus-color-mod/simpletex_lcd_720p+gba-color.slangp
...
namespace RetroArch
{
class PresetsHandheldPlusColorModSimpletex_lcd_720pGbaColorPresetDef : public PresetDef
{
public:
	PresetsHandheldPlusColorModSimpletex_lcd_720pGbaColorPresetDef() : PresetDef{}
	{
		Name = "simpletex_lcd_720p+gba-color";
