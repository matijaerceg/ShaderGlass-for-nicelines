/*
ShaderGlass preset presets/handheld-plus-color-mod / lcd-grid-v2-sp101-color-motionblur imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/handheld-plus-color-mod/lcd-grid-v2-sp101-color-motionblur.slangp
...
namespace RetroArch
{
class PresetsHandheldPlusColorModLcdGridV2Sp101ColorMotionblurPresetDef : public PresetDef
{
public:
	PresetsHandheldPlusColorModLcdGridV2Sp101ColorMotionblurPresetDef() : PresetDef{}
	{
		Name = "lcd-grid-v2-sp101-color-motionblur";
