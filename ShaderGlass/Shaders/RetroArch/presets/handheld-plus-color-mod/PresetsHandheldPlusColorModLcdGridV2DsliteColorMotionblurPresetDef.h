/*
ShaderGlass preset presets/handheld-plus-color-mod / lcd-grid-v2-dslite-color-motionblur imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/handheld-plus-color-mod/lcd-grid-v2-dslite-color-motionblur.slangp
...
namespace RetroArch
{
class PresetsHandheldPlusColorModLcdGridV2DsliteColorMotionblurPresetDef : public PresetDef
{
public:
	PresetsHandheldPlusColorModLcdGridV2DsliteColorMotionblurPresetDef() : PresetDef{}
	{
		Name = "lcd-grid-v2-dslite-color-motionblur";
