/*
ShaderGlass preset presets/handheld-plus-color-mod / lcd-grid-v2-gba-color-motionblur imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/handheld-plus-color-mod/lcd-grid-v2-gba-color-motionblur.slangp
...
namespace RetroArch
{
class PresetsHandheldPlusColorModLcdGridV2GbaColorMotionblurPresetDef : public PresetDef
{
public:
	PresetsHandheldPlusColorModLcdGridV2GbaColorMotionblurPresetDef() : PresetDef{}
	{
		Name = "lcd-grid-v2-gba-color-motionblur";
