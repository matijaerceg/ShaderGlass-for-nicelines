/*
ShaderGlass preset presets/handheld-plus-color-mod / lcd-grid-v2-gbMicro-color-motionblur imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/handheld-plus-color-mod/lcd-grid-v2-gbMicro-color-motionblur.slangp
...
namespace RetroArch
{
class PresetsHandheldPlusColorModLcdGridV2GbMicroColorMotionblurPresetDef : public PresetDef
{
public:
	PresetsHandheldPlusColorModLcdGridV2GbMicroColorMotionblurPresetDef() : PresetDef{}
	{
		Name = "lcd-grid-v2-gbMicro-color-motionblur";
...
.Param("name", "SamplerLUT2"));
            ...
            OverrideParam("response_time", (float)0.333000);
	}
};
}
