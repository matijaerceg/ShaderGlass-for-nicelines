/*
ShaderGlass preset presets/crt-plus-signal / crt-royale-ntsc-composite imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-plus-signal/crt-royale-ntsc-composite.slangp
...
namespace RetroArch
{
class PresetsCrtPlusSignalCrtRoyaleNtscCompositePresetDef : public PresetDef
{
public:
	PresetsCrtPlusSignalCrtRoyaleNtscCompositePresetDef() : PresetDef{}
	{
		Name = "crt-royale-ntsc-composite";
