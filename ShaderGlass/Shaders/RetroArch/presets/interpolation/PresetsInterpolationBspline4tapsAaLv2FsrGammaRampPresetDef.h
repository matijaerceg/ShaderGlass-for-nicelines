/*
ShaderGlass preset presets/interpolation / bspline-4taps-aa-lv2-fsr-gamma-ramp imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/interpolation/bspline-4taps-aa-lv2-fsr-gamma-ramp.slangp
...
namespace RetroArch
{
class PresetsInterpolationBspline4tapsAaLv2FsrGammaRampPresetDef : public PresetDef
{
public:
	PresetsInterpolationBspline4tapsAaLv2FsrGammaRampPresetDef() : PresetDef{}
	{
		Name = "bspline-4taps-aa-lv2-fsr-gamma-ramp";
...
.Param("srgb_framebuffer", "false")
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("AAOFFSET2", (float)1.250000);
