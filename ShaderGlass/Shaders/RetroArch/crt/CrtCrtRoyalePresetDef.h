/*
ShaderGlass preset crt / crt-royale imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/crt/crt-royale.slangp
...
namespace RetroArch
{
class CrtCrtRoyalePresetDef : public PresetDef
{
public:
	CrtCrtRoyalePresetDef() : PresetDef{}
	{
		Name = "crt-royale";
		Category = "crt";
	}
