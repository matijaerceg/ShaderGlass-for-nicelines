/*
ShaderGlass preset crt / crt-maximus-royale-fast-mode imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/crt/crt-maximus-royale-fast-mode.slangp
...
namespace RetroArch
{
class CrtCrtMaximusRoyaleFastModePresetDef : public PresetDef
{
public:
	CrtCrtMaximusRoyaleFastModePresetDef() : PresetDef{}
	{
		Name = "crt-maximus-royale-fast-mode";
		Category = "crt";
	}
