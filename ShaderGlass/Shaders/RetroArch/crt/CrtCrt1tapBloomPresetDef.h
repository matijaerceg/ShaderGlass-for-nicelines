/*
ShaderGlass preset crt / crt-1tap-bloom imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/crt/crt-1tap-bloom.slangp
...
namespace RetroArch
{
class CrtCrt1tapBloomPresetDef : public PresetDef
{
public:
	CrtCrt1tapBloomPresetDef() : PresetDef{}
	{
		Name = "crt-1tap-bloom";
		Category = "crt";
	}
...
.Param("srgb_framebuffer", "false")
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("BLOOM_THRESHOLD", (float)2.500000);
            OverrideParam("BLUR_RADIUS", (float)2.000000);
            OverrideParam("EYE_ADAPTION", (float)0.850000);
            OverrideParam("MIN_EXP_INTENSITY", (float)0.500000);
