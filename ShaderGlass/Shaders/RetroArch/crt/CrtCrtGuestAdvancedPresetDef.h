...
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/crt/crt-guest-advanced.slangp
...
namespace RetroArch
{
class CrtCrtGuestAdvancedPresetDef : public PresetDef
{
public:
	CrtCrtGuestAdvancedPresetDef() : PresetDef{}
	{
		Name = "crt-guest-advanced";
		Category = "crt";
	}
...
.Param("scale", "1.0")
.Param("scale_type", "source"));
         	ShaderDefs.push_back(CrtShadersGuestAdvancedAvgLumShaderDef()
.Param("alias", "AvgLumPass")
.Param("filter_linear", "true")
.Param("mipmap_input", "true")
.Param("scale", "1.0")
.Param("scale_type", "source"));
         	ShaderDefs.push_back(CrtShadersGuestAdvancedLinearizeShaderDef()
