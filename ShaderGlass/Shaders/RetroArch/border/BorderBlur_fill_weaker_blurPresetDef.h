/*
ShaderGlass preset border / blur_fill_weaker_blur imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/border/blur_fill_weaker_blur.slangp
...
namespace RetroArch
{
class BorderBlur_fill_weaker_blurPresetDef : public PresetDef
{
public:
	BorderBlur_fill_weaker_blurPresetDef() : PresetDef{}
	{
		Name = "blur_fill_weaker_blur";
		Category = "border";
	}
...
.Param("scale", "1.0")
.Param("scale_type", "viewport"));
            OverrideParam("BLUR_RADIUS", (float)1.000000);
