/*
ShaderGlass preset border/gameboy-player / gameboy-player-tvout imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/border/gameboy-player/gameboy-player-tvout.slangp
...
namespace RetroArch
{
class BorderGameboyPlayerGameboyPlayerTvoutPresetDef : public PresetDef
{
public:
	BorderGameboyPlayerGameboyPlayerTvoutPresetDef() : PresetDef{}
	{
		Name = "gameboy-player-tvout";
...
.Param("name", "BORDER"));
            ...
            OverrideParam("TVOUT_RESOLUTION", (float)480.000000);
