/*
ShaderGlass preset border/gameboy-player / gameboy-player-tvout-gba-color imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/border/gameboy-player/gameboy-player-tvout-gba-color.slangp
...
namespace RetroArch
{
class BorderGameboyPlayerGameboyPlayerTvoutGbaColorPresetDef : public PresetDef
{
public:
	BorderGameboyPlayerGameboyPlayerTvoutGbaColorPresetDef() : PresetDef{}
	{
		Name = "gameboy-player-tvout-gba-color";
