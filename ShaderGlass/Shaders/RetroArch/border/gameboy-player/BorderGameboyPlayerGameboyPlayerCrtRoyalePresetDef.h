/*
ShaderGlass preset border/gameboy-player / gameboy-player-crt-royale imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/border/gameboy-player/gameboy-player-crt-royale.slangp
...
namespace RetroArch
{
class BorderGameboyPlayerGameboyPlayerCrtRoyalePresetDef : public PresetDef
{
public:
	BorderGameboyPlayerGameboyPlayerCrtRoyalePresetDef() : PresetDef{}
	{
		Name = "gameboy-player-crt-royale";
