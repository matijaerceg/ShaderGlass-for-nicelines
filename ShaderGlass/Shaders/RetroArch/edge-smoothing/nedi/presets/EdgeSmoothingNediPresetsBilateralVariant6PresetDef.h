/*
ShaderGlass preset edge-smoothing/nedi/presets / bilateral-variant6 imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/edge-smoothing/nedi/presets/bilateral-variant6.slangp
...
namespace RetroArch
{
class EdgeSmoothingNediPresetsBilateralVariant6PresetDef : public PresetDef
{
public:
	EdgeSmoothingNediPresetsBilateralVariant6PresetDef() : PresetDef{}
	{
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("SIGMA_R", (float)0.200000);
